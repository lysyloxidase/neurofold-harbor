# NeuroFold v8 — amyloid-beta 42 (Alzheimer's disease)

Control a stochastic, sequence-conditioned coarse-grained conformational
surrogate of an Aβ42 **dimer** and suppress pathological β-register formation
...
Two chains of 5-residue beads start with a partial antiparallel β-register
already present: an early-stage nucleation event. Left alone, that register
